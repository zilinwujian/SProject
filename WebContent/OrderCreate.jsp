            ...
            <ul>
                ...
                <li  class="current"><a href="#"><img src="/SSHProject/img/icons/menu/brush.png" alt="" /> Member</a>
                    <ul>
                        ...
                        <li class="current"><a href="OrderCreate.jsp">OrderCreate</a></li>
                    </ul>
                </li>
...
<div class="bloc">
    ...
    <div class="content">
      <s:form action="ordercreate">
        <div class="input">
            <label for="input1">CommdityID</label>
            <input type="text" name = "orderform.commdityid" id="input1"/>
        </div>
        <div class="input">
            <label for="input1">Number</label>
            <input type="text" name = "orderform.number" id="input1"/>
        </div>
        <div class="submit">
