...
<div class="bloc">
    ...
    <div class="content">
		...
		<label for="input1">
			<p>The CommodityNumber you chose</p><Nam>GetQueryString("id")</Nam>
		</label>
		<!-- -------------------------------------------------------------------- -->

		<div class="input">
            	<label for="input1">数量</label>
            	<input type="text" name = "buy.number" id="input1" />
        </div>
        
        <div class="input">
            	<label for="input1">商品号</label>
            	<input type="text" name = "buy.commodityid" id="inputcom"/>
        </div>
        ...
        <script type="text/javascript">
            ...
            <select name="buy.clerkid" id="select2" onchange = "changeAction2();">
