            ...
            <ul>
                ...
                <li  class="current"><a href="#"><img src="/SSHProject/img/icons/menu/brush.png" alt="" />System Manager</a>
                    <ul>
                        ...
                        <li class="current"><a href="ClerkCreate.jsp">CreateClerk</a></li>
                    </ul>
                </li>
              </ul>
...
<div class="bloc">
    <div class="title">Clerk</div>
    <div class="content">
      <s:form action="clerkcreateaction">
        <div class="input">
            <label for="input1">isBranch</label>
            <input type="text" name = "store.isbranch" id="input1" value = 0 />
        </div>
        <div class="input">
            <label for="input1">BelongsTo</label>
            <input type="text" name = "store.storeid" id="input1"/>
        </div>
        <div class="submit">
            <input type="submit" value="Create Clerk" />
        </div>
       </s:form>
    </div>
</div>     
