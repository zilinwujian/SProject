       ...
       <div id="sidebar">
            <ul>
                ...
                <li  class="current"><a href="#"><img src="/SSHProject/img/icons/menu/brush.png" alt="" /> Manager</a>
                    <ul>
                        <li  class="current"><a href="allcpaction.action">CommodityPlansShow</a></li>
...
<div class="bloc">
    <div class="title">Show CP list</div>
    <div class="content">
         <table>
            <thead>
                <tr>
            ...
            <tbody>
            	<s:iterator value="#request.list" id="us">  
                    ...
                    <td>
                    	<s:a href = "permitaction.action?cpid=%{#us.commdityplanid}">Permit</s:a>
                    </td>
                    </tr>
               </s:iterator> 
                            </tbody>
